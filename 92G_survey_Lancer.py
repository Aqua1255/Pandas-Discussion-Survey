...
df = pd.read_csv(r'/home/coho/Desktop/Work/92G_survey.csv', error_bad_lines=False, engine='python',
                 sep=',')
filtered_df = df[df['In which Warrior Restaurant do you work?'].str.contains('Lancer Bistro', case=False)]
...
writer = pd.ExcelWriter('../Desktop/Work/92G_survey_lancer.xlsx')
